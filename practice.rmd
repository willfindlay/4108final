...
- capture a value and replay it to the originating party
- like replay attack except send it back instead of sending it to someone else
...
- act as a proxy between two end parties

#### Interleaving

- weaving together messages from two distinct protocols

#### Forward Search

- feeding guesses into hash function, seeking matches

#### Pre-Capture

- social engineering to steal client OTP for later use
...
- subjects have one or more roles
- permissions are based on roles

#### MAC

- mandatory access control
- system administrator decides who has access to objects
...
- object owners (subjects who own objects) decide who has access to their objects
- this is commodity OS model
    - Linux
    - MacOS (although MacOS has elements of MAC)
    - Windows
    - etc.
...
- tricks the browser (via a link or XSS or malicious page) into sending a request
    - this request is pre-authorized due to the authentication cookie
