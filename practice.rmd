...
\question{Circle the trust anchor for the right-most leaf in \autoref{ca-hierarchies}.}
\vspace{1em}
...
\question{Circle the trust anchor for the right-most leaf in \autoref{bt-question}.}
\vspace{1em}
